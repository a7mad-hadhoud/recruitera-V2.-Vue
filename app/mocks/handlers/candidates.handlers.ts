...
const ALL_CANDIDATES: Candidate[] = [
  ...
  { id: '5',  name: 'Mikel Lang (Sample)',      initials: 'ML', avatarColor: 'var(--brand-avatar-2)', isNew: false, status: 'not_contacted', jobs: [{ title: 'Recruiter (Sample)', status: 'internal' }],                                                  sources: ['LinkedIn'],     tags: ['Sample', 'Mid-level'],        talentPools: [],                            disqualifiedBy: null,               dateCreated: 'a month ago' },
