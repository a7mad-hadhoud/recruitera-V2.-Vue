  ...
  <header class="sticky top-0 z-30 border-b border-black/5 bg-white px-4 py-3.5 sm:px-6" :style="{ fontFamily: `${site.font}, system-ui, sans-serif` }">
    <div class="mx-auto flex max-w-[1200px] items-center justify-between">
      ...
      <div class="hidden items-center gap-3 sm:flex">
        ...
        <button type="button" class="grid size-8 shrink-0 place-items-center rounded-md text-[12px] font-bold" :style="{ background: site.headerColor, color: 'white' }" :aria-label="locale === 'en' ? 'Switch to Arabic' : 'Switch to English'" @click="toggleLocale">
          {{ locale === 'en' ? 'ع' : 'EN' }}
        </button>
