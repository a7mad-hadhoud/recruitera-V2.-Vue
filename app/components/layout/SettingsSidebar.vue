...
const groups: Group[] = [
  ...
  { key: 'templates', label: 'Templates', icon: LayoutTemplate, children: [
    { label: 'Email templates', to: '/settings/templates/email' },
    { label: 'Screening questions', to: '/settings/templates/application-forms' },
    { label: 'Evaluation forms', to: '/settings/templates/evaluation-forms' },
    { label: 'Questionnaires', to: '/settings/templates/questionnaires' },
    { label: 'Benefits', to: '/settings/templates/benefits' },
    { label: 'Pipelines', to: '/settings/templates/pipeline' },
    { label: 'WhatsApp templates', to: '/settings/templates/whatsapp' },
    { label: 'Jobs', to: '/settings/templates/job-templates' },
    { label: 'Referral questions', to: '/settings/templates/referral' },
    { label: 'Offer letters', to: '/settings/templates/offer' },
  ]},
